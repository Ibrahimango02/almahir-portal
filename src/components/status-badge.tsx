...
export function StatusBadge({ status, className }: StatusBadgeProps) {
  ...
  const statusStyles: Record<string, string> = {
    ...
    inactive:
      "bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-900/50 dark:text-slate-400 dark:border-slate-800/60",
    pending:
    ...
    archived: "bg-sky-100 text-sky-700 border-sky-200 dark:bg-sky-950/50 dark:text-sky-400 dark:border-sky-800/60",
