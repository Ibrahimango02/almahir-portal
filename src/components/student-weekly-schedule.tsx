...
type StudentWeeklyScheduleProps = {
...
export function StudentWeeklySchedule({ filter }: StudentWeeklyScheduleProps) {
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <div className="flex gap-1">
                        {classItem.attendance_status && (
                          <Badge
                            variant={
                              classItem.attendance_status === "present"
                                ? "default"
                                : classItem.attendance_status === "absent"
                                  ? "destructive"
                                  : "outline"
                            }
                            className="text-xs"
