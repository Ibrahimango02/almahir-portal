    ...
    <div className="flex flex-col gap-6">
      ...
      <Card className="max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>Send an invitation to a student to join the Al-Mahir Academy Portal.</CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                The invitation code will be included in the email sent to the student.
              </p>
            </div>
          </CardContent>
