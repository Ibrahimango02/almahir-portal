  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card className="max-w-2xl">
        <CardHeader>
          <CardTitle>Invite a New Teacher</CardTitle>
          <CardDescription>Send an invitation to a teacher to join the Al-Mahir Academy Portal.</CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                The invitation code will be included in the email sent to the teacher.
              </p>
            </div>
          </CardContent>
